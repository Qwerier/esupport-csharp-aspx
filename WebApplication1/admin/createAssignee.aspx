<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createAssignee.aspx.cs" Inherits="WebApplication1.admin.createAssignee" %>
...
<head runat="server">
    ...
    <tr align="center" >
        ...
        <tr>
                ...
                <td align="right">
                <br />
                    <asp:Button ID="btnSubmit" runat="server" Font-Bold="true" Font-Size="12pt" ForeColor="floralwhite" BackColor="Green" Text="Krijo Punonjës" OnClick="btnSubmit_Click" />
                </td>
                <td align="left">
                <br />
                <asp:Button ID="btnCancel" runat="server"  Text="Cancel" Font-Size="12pt" Font-Bold="true" ForeColor="floralwhite" BackColor="Green" CausesValidation="false" OnClick="btnCancel_Click" Width="132px" style="height: 36px" />
                </td>
        </tr>
    </table>
