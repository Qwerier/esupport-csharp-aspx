    ...
    public partial class view_email : System.Web.UI.Page
    {
        ...
        private void Read_Emails()
        {
            ...
            if (Session["Pop3Client"] == null)
            {
                ...
                pop3Client.Authenticate("youremail@gmail.com", "password");
            ...
            for (int i = count; i >= 1; i--)
            {
                ...
                cn.Open();
                //Merr nga databaza  ku requestCategory eshte si subjekti
                string ser = "select requestCategory FROM request WHERE userID='" + subjekt + "'";
