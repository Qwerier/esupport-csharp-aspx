<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="changePswdAdmin.aspx.cs" Inherits="WebApplication1.admin.changePswdAdmin" %>
        ...
        <tr align="center">
          ...
          <tr>
            ...
            <items>
                ...
                <asp:MenuItem Text="Krijo Menaxher"  Value="Create New Manager" NavigateUrl="~/cadmin/reateManager.aspx"></asp:MenuItem>
                  ...
                  <asp:MenuItem Text="Email" Value="email" NavigateUrl="~/view_email.aspx" ></asp:MenuItem>
        ...
        <tr>
         ...
         <tr>
             ...
             <tr>
                            ...
                            <asp:Button ID="btnSubmit" runat="server" Font-Bold="true" Text="Ndrysho" Width="150px" ForeColor="FloralWhite" BackColor="Green" OnClick="btnSubmit_Click" />
                            </td>
