...
namespace WebApplication1.admin
{
    public partial class specificProcessedRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cnUser.Open();
            string selUser = "select FIRSTNAME,LASTNAME,EMAIL_ADDRESS from register where userID= " + u_id + "";
        ...
        protected void btnDeletereq_Click(object sender, EventArgs e)
        {
            ...
            cnDelQuery.Open();
            string delProccesedquery = "delete from requestArrivedAtManager where userID='" + u_id + "'";
