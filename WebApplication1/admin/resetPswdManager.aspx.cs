...
{
    public partial class resetPswdManager : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string SpecificAssignee = "select FIRSTNAME,LASTNAME,USERNAME,department,email from managerLogin where USERNAME='" + Uname + "'";
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            cnupdt.Open();
            string updtpswd = "update managerLogin set PASSWORD='" + txtNewpswd.Text.Trim() + "'where USERNAME='" + Uname + "'";
            ...
            cnReset = new SqlConnection(ConfigurationManager.ConnectionStrings["OHDConn"].ConnectionString);
            cnReset.Open();
            string resetTable = "update managerPswd set reset ='" + reset + "'  where USERNAME='" + Uname + "'";
