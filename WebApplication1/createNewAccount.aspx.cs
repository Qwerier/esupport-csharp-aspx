        ...
        protected void btnSubmit_Click1(object sender, EventArgs e)
        {
            if (rbtAccept.Checked.ToString() == "True")
            {
                ...
                else
                {
                    ...
                    cn.Open();
                    string str = "insert into register(FIRSTNAME,LASTNAME,USERNAME,PASSWORD,RETYPE_PASSWORD,EMAIL_ADDRESS,ADDRESS,MOBILE_NO,GENDER,dobDays,dobMonths,Year)" + " values('" + txtFname.Text.Trim() + "','" + txtLname.Text.Trim() + "','" + txtUname.Text.Trim() + "','" + txtPassword.Text.Trim() + "','" + txtRpswd.Text.Trim() + "','" + txtEmail.Text.Trim() + "','" + txtAdd.Text.Trim() + "', " + txtMob.Text.Trim() + ",'" + txtGender + "','" + ddlDays.SelectedValue + "','" + ddlMonth.SelectedValue + "','" + txtYear.Text.Trim() + "' )";
