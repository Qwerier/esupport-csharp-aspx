...
namespace WebApplication1.punonjes
{
    public partial class requestArrivedForAssignee : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sqlConn.Open();
            string queryRequest = "select request,requestID,requestCategory,userID,deadline from request where requestId in(Select requestID from requestArrivedAtAssignee where assigneeName = '" + uName + "') and solution is null ";
