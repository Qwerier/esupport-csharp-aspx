<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reqForpswd.aspx.cs"  Inherits="WebApplication1.admin.reqForpswd" %>
<!DOCTYPE html>
...
<head runat="server">
 ...
 <table width="100%" >
        <tr align="center">
        <td align="center" style="text-decoration:underline; color:Teal;">
       
        
                <h3> Klientet qe kane harruar fjalekalimin</h3>
        </td>
        </tr>
        <tr>
