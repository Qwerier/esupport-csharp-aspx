<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seeManager.aspx.cs" Inherits="WebApplication1.admin.seeManager" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Menaxheret</title>
   ...
   <form id="form2" runat="server">
    ...
    <tr align="center">
        <td align="center"  >
        <h3 class="auto-style4">Lista e Menaxhereve</h3>
        <br />
        <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="SELECT * FROM managerLogin" ConnectionString="<%$ ConnectionStrings:OHDConnectionString1 %>" ProviderName="<%$ ConnectionStrings:OHDConnectionString1.ProviderName %>"></asp:SqlDataSource>
