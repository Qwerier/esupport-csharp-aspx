<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reqForPwdAssignee.aspx.cs"  Inherits="WebApplication1.admin.reqForPwdAssignee" %>\
<!DOCTYPE html>
...
<table width="100%" >
        <tr>
                ...
                <h3>Punonjesit qe kane harruar fjalekalimin</h3>
                </td>
        </tr>
    ...
    <tr>
        <td align="center">
            ...
            <asp:GridView ID="gvRequestpwd" runat="server" CellPadding="2" CellSpacing="4" AllowPaging="true"  DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display."  AutoGenerateColumns="False">
                ...
                <Columns>
                <asp:HyperLinkField  HeaderText="Reset Password" DataNavigateUrlFields="username" DataNavigateUrlFormatString="resetPswdAssignee
.aspx?username={0}" Text="Reset"   />
